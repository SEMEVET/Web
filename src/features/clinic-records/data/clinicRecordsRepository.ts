...
function mapConsultation(row: ConsultationRow): Consultation {
  return {
    ...
    relevantHistory: row.antecedentes_relevantes ?? '',
    ...
    tllc: row.tllc ?? '',
    hydration: row.hidratacion ?? '',
    bodyCondition: row.condicion_corporal ?? '',
    pain: row.dolor ?? '',
    clinicalFindings: row.hallazgos_clinicos ?? '',
    presumptiveDiagnosis: row.diagnostico_presuntivo ?? '',
    differentialDiagnoses: row.diagnosticos_diferenciales ?? '',
    definitiveDiagnosis: row.diagnostico_definitivo ?? '',
    treatment: row.tratamiento ?? '',
    prescribedMedications: row.medicamentos_indicados ?? '',
    suggestedTests: row.examenes_sugeridos ?? '',
    indications: row.indicaciones ?? '',
    controlCriteria: row.criterio_control ?? '',
    referralCriteria: row.criterio_derivacion ?? '',
...
function toConsultationInsert(consultation: Omit<Consultation, 'id'>): ConsultationInsert {
  return {
    ...
    tipo_atencion: emptyToNull(consultation.attentionType),
    motivo: consultation.reason.trim(),
    anamnesis: emptyToNull(consultation.anamnesis),
    antecedentes_relevantes: emptyToNull(consultation.relevantHistory),
    ...
    peso: toNumberOrNull(consultation.weight),
    mucosas: emptyToNull(consultation.mucousMembranes),
    tllc: emptyToNull(consultation.tllc),
    hidratacion: emptyToNull(consultation.hydration),
    condicion_corporal: emptyToNull(consultation.bodyCondition),
    dolor: emptyToNull(consultation.pain),
    hallazgos_clinicos: emptyToNull(consultation.clinicalFindings),
    diagnostico_presuntivo: emptyToNull(consultation.presumptiveDiagnosis),
    diagnosticos_diferenciales: emptyToNull(consultation.differentialDiagnoses),
    diagnostico_definitivo: emptyToNull(consultation.definitiveDiagnosis),
    tratamiento: emptyToNull(consultation.treatment),
    medicamentos_indicados: emptyToNull(consultation.prescribedMedications),
    examenes_sugeridos: emptyToNull(consultation.suggestedTests),
    indicaciones: emptyToNull(consultation.indications),
    criterio_control: emptyToNull(consultation.controlCriteria),
    criterio_derivacion: emptyToNull(consultation.referralCriteria),
...
function toConsultationUpdate(consultation: Partial<Omit<Consultation, 'id'>>): ConsultationUpdate {
  return removeUndefined({
    ...
    fecha: consultation.date,
    tipo_atencion: consultation.attentionType === undefined ? undefined : emptyToNull(consultation.attentionType),
    motivo: consultation.reason?.trim(),
    anamnesis: consultation.anamnesis === undefined ? undefined : emptyToNull(consultation.anamnesis),
    antecedentes_relevantes:
      consultation.relevantHistory === undefined ? undefined : emptyToNull(consultation.relevantHistory),
    ...
    peso: consultation.weight === undefined ? undefined : toNumberOrNull(consultation.weight),
    ...
    hidratacion: consultation.hydration === undefined ? undefined : emptyToNull(consultation.hydration),
    condicion_corporal: consultation.bodyCondition === undefined ? undefined : emptyToNull(consultation.bodyCondition),
    dolor: consultation.pain === undefined ? undefined : emptyToNull(consultation.pain),
    hallazgos_clinicos:
      consultation.clinicalFindings === undefined ? undefined : emptyToNull(consultation.clinicalFindings),
    diagnostico_presuntivo:
      consultation.presumptiveDiagnosis === undefined ? undefined : emptyToNull(consultation.presumptiveDiagnosis),
    diagnosticos_diferenciales:
      consultation.differentialDiagnoses === undefined ? undefined : emptyToNull(consultation.differentialDiagnoses),
    ...
    medicamentos_indicados:
      consultation.prescribedMedications === undefined ? undefined : emptyToNull(consultation.prescribedMedications),
    examenes_sugeridos: consultation.suggestedTests === undefined ? undefined : emptyToNull(consultation.suggestedTests),
    indicaciones: consultation.indications === undefined ? undefined : emptyToNull(consultation.indications),
    criterio_control: consultation.controlCriteria === undefined ? undefined : emptyToNull(consultation.controlCriteria),
    criterio_derivacion:
      consultation.referralCriteria === undefined ? undefined : emptyToNull(consultation.referralCriteria),
